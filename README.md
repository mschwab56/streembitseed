...
"port": Enter the port number whcih configured in the firewalland can listen on incoming Streembit requests. Make sure it formatted as number, not as string!
